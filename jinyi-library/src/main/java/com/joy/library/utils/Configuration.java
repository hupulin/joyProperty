...
/**
 * Allows configuring a {@link AppMsg}s behaviour aside from the actual view,
 ...
 * when the {@link AppMsg} is being displayed.
 *
 * @author chris
 * @since 1.8
 */
public class Configuration {
  ...
  /**
   * Display a {@link AppMsg} for an infinite amount of time or
   * until {@link AppMsg#cancel()} has been called.
   */
  public static final int DURATION_INFINITE = -1;
  /** The default short display duration of a {@link AppMsg}. */
  public static final int DURATION_SHORT = 3000;
  /** The default long display duration of a {@link AppMsg}. */
  public static final int DURATION_LONG = 5000;

  /** The default {@link Configuration} of a {@link AppMsg}. */
  ...
  /** The durationInMilliseconds the {@link AppMsg} will be displayed in milliseconds. */
  ...
  public static class Builder {
    ...
    /**
     * Set the durationInMilliseconds option of the {@link AppMsg}.
     *
     * @param duration
     *   The durationInMilliseconds the crouton will be displayed
     *   {@link AppMsg} in milliseconds.
     *
     ...
     *   when the {@link AppMsg} is going to be displayed.
     *
     * @return the {@link Builder}.
     */
     ...
     *   The resource identifier for the animation that's being shown
     *   when the {@link AppMsg} is going to be removed.
     *
     * @return the {@link Builder}.
     */
