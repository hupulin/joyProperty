...
public class EasySlidingTabs_record extends HorizontalScrollView {
    ...
    public EasySlidingTabs_record(Context context) {
        this(context, null);
    }

    public EasySlidingTabs_record(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context, attrs);
    }

    public EasySlidingTabs_record(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void addTabs() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                EasySlidingTabs_record.this.currentPosition = EasySlidingTabs_record.this.pager.getCurrentItem();
                scrollToChild(EasySlidingTabs_record.this.currentPosition, 0);
            }
        });
    }
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                EasySlidingTabs_record.this.pager.setCurrentItem(position);
            }
        });
...
//        tab.setPadding(2, 0, 2, 0);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            EasySlidingTabs_record.this.currentPosition = position;
            EasySlidingTabs_record.this.currentPositionOffset = positionOffset;

            View view = EasySlidingTabs_record.this.tabsContainer.getChildAt(position);
            if (view == null) {
                return;
            }
            ...
            if (EasySlidingTabs_record.this.delegatePageListener != null) {
                EasySlidingTabs_record.this.delegatePageListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
            }
        }
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == ViewPager.SCROLL_STATE_IDLE) {
                scrollToChild(EasySlidingTabs_record.this.pager.getCurrentItem(), 0);
            }

            if (EasySlidingTabs_record.this.delegatePageListener != null) {
                EasySlidingTabs_record.this.delegatePageListener.onPageScrollStateChanged(state);
            }
        }

        @Override
        public void onPageSelected(int position) {
            EasySlidingTabs_record.this.selectedPosition = position;
            updateTabStyles();
            if (EasySlidingTabs_record.this.delegatePageListener != null) {
                EasySlidingTabs_record.this.delegatePageListener.onPageSelected(position);
            }
        }
