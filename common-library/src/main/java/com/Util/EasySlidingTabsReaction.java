...
public class EasySlidingTabsReaction extends HorizontalScrollView {
    ...
    public EasySlidingTabsReaction(Context context) {
        this(context, null);
    }

    public EasySlidingTabsReaction(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context, attrs);
    }

    public EasySlidingTabsReaction(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.tabsContainer.setDescendantFocusability(ViewGroup.FOCUS_AFTER_DESCENDANTS );
    ...
    private void addTabs() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                EasySlidingTabsReaction.this.currentPosition = EasySlidingTabsReaction.this.pager.getCurrentItem();
                scrollToChild(EasySlidingTabsReaction.this.currentPosition, 0);
            }
        });
    }
    ...
    private void addIconTab(final int position, int resId) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i("2222", "onClick: 点击了"+position);
                EasySlidingTabsReaction.this.pager.setCurrentItem(position);
            }
        });
...
//        tab.setPadding(2, 0, 2, 0);
        ...
        if (this.defaultTabLayoutParams == null) {
            ...
            this.tabWidth = this.width / (this.tabCount > 3 ? 3 : this.tabCount);
                ...
                if (v instanceof TextView) {
                    ...
                    if (i == this.selectedPosition) {
                       int width= getResources().getDisplayMetrics().widthPixels;
                        float textSize=(float)(0.03*width);
                       textSize=textSize>=18?18:textSize;
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            EasySlidingTabsReaction.this.currentPosition = position;
            EasySlidingTabsReaction.this.currentPositionOffset = positionOffset;

            View view = EasySlidingTabsReaction.this.tabsContainer.getChildAt(position);
            if (view == null) {
                return;
            }
            ...
            if (EasySlidingTabsReaction.this.delegatePageListener != null) {
                EasySlidingTabsReaction.this.delegatePageListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
            }
        }
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == ViewPager.SCROLL_STATE_IDLE) {
                scrollToChild(EasySlidingTabsReaction.this.pager.getCurrentItem(), 0);
            }

            if (EasySlidingTabsReaction.this.delegatePageListener != null) {
                EasySlidingTabsReaction.this.delegatePageListener.onPageScrollStateChanged(state);
            }
        }

        @Override
        public void onPageSelected(int position) {
            EasySlidingTabsReaction.this.selectedPosition = position;
            updateTabStyles();
            if (EasySlidingTabsReaction.this.delegatePageListener != null) {
                EasySlidingTabsReaction.this.delegatePageListener.onPageSelected(position);
            }
        }
