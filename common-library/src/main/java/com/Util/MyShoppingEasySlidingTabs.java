...
public class MyShoppingEasySlidingTabs extends HorizontalScrollView {
    ...
    public MyShoppingEasySlidingTabs(Context context) {
        this(context, null);
    }

    public MyShoppingEasySlidingTabs(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context, attrs);
    }

    public MyShoppingEasySlidingTabs(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void addTabs() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                MyShoppingEasySlidingTabs.this.currentPosition = MyShoppingEasySlidingTabs.this.pager.getCurrentItem();
                scrollToChild(MyShoppingEasySlidingTabs.this.currentPosition, 0);
            }
        });
    }
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                MyShoppingEasySlidingTabs.this.pager.setCurrentItem(position);
            }
        });
...
//        tab.setPadding(2, 0, 2, 0);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            MyShoppingEasySlidingTabs.this.currentPosition = position;
            MyShoppingEasySlidingTabs.this.currentPositionOffset = positionOffset;

            View view = MyShoppingEasySlidingTabs.this.tabsContainer.getChildAt(position);
            if (view == null) {
                return;
            }
            ...
            if (MyShoppingEasySlidingTabs.this.delegatePageListener != null) {
                MyShoppingEasySlidingTabs.this.delegatePageListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
            }
        }
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == ViewPager.SCROLL_STATE_IDLE) {
                scrollToChild(MyShoppingEasySlidingTabs.this.pager.getCurrentItem(), 0);
            }

            if (MyShoppingEasySlidingTabs.this.delegatePageListener != null) {
                MyShoppingEasySlidingTabs.this.delegatePageListener.onPageScrollStateChanged(state);
            }
        }

        @Override
        public void onPageSelected(int position) {
            MyShoppingEasySlidingTabs.this.selectedPosition = position;
            updateTabStyles();
            if (MyShoppingEasySlidingTabs.this.delegatePageListener != null) {
                MyShoppingEasySlidingTabs.this.delegatePageListener.onPageSelected(position);
            }
        }
