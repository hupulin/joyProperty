...
import com.joyhome.nacity.app.photo.util.BitmapCache;
...
public class FolderAdapter extends BaseAdapter {
	...
	public FolderAdapter(Context c, int number, String flag,String type) {
	...
	public int getCount() {
		int count=0;
//		return AlbumActivity==null?0:(AlbumActivity.contentList==null?0:AlbumActivity.contentList.size());
		if(AlbumActivity.contentList==null)
			count = NeighborAlbumActivity.contentList.size();
		else
			count=AlbumActivity.contentList.size();
...
//			holder.imageView.setLayoutParams(lp);
		...
		String path;
		if(AlbumActivity.contentList==null)
			AlbumActivity.contentList=NeighborAlbumActivity.contentList;
...
//			holder.imageView.setImageBitmap( AlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
	...
	private class ImageViewClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			intent= new Intent(mContext, ShowAllPhoto.class);
