...
public class NeighborAlbumActivity extends BaseActivity {
    //显示手机里的所有图片的列表控件
    ...
    private class PreviewListener implements OnClickListener {
        public void onClick(View v) {
            if (Bimp.tempSelectBitmap.size() > 0) {
                ...
                intent.setClass(NeighborAlbumActivity.this, GalleryActivity.class);
    ...
    private class AlbumSendListener implements OnClickListener {
        public void onClick(View v) {
            if("1".equals(type)){
                SpUtil.put(getThisContext(), "firstAlum", true);
                Intent intent=new Intent(getThisContext(), FeedBackTaskActivity.class);
                intent.putExtra("isNeighbor",true);
                intent.putExtra("mode",getIntent().getSerializableExtra("mode"));
                startActivity(intent);
                finish();
            }else{
                SpUtil.put(getThisContext(), "firstAlum", true);
                Intent intent=new Intent(getThisContext(), PostActivity.class);
                intent.putExtra("isNeighbor",true);
                startActivity(intent);
                finish();
            }
    ...
    private class BackListener implements OnClickListener {
        public void onClick(View v) {
            intent = new Intent(NeighborAlbumActivity.this, ImageFile.class);
                    ...
                    public void onItemClick(final ToggleButton toggleButton,
                        ...
                        if (Bimp.tempSelectBitmap.size() >= num) {
                            ...
                            if (!removeOneData(dataList.get(position))) {
                                Toast.makeText(NeighborAlbumActivity.this, "最多能上传" + num + "张图片",
