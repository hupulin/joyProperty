 ...
 */
public class NeighborListAdapter extends ModeListAdapter<ServiceReportFlowTo> {
...
//        String hehe=mode.getValue().toString()+"";
//         NeighborService MY= JSON.parseObject(hehe, NeighborService.class);
//         System.out.println(MY.getCount()+"coumt"+MY.getTodaycomment()+"Todaycomment"+MY.getTodaycount()+"todaycount");
        System.out.println(mode.getValue().toString()+"value");


        LayoutInflater inflater = LayoutInflater.from(mContext);
        if (row == null) {
            row = inflater.inflate(R.layout.list_apartment_itemselect, null);
