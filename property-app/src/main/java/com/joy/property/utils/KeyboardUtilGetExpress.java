...
/**
 *  Created by usb on 2017/12/13.
 */



    public class KeyboardUtilGetExpress {
        ...
        public KeyboardUtilGetExpress(Activity activity, CustomDialog view,EditText edit) {
            mActivity = activity;
            ...
            mKeyboardView = (KeyboardView) view
