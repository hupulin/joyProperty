...
public class ResultListAdapter extends BaseAdapter {
    ...
    public ResultListAdapter(Context mContext, List<ApartmentInfoTo> mCities) {
        this.mCities = mCities;
        this.mContext = mContext;
    }

    public void changeData(List<ApartmentInfoTo> list){
        if (mCities == null){
            mCities = list;
        }else{
            mCities.clear();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder.name.setText(mCities.get(position).getApartmentName());
        return view;
    }
