package com.joy.property.task.TimePickerDialog.config;
...
public class PickerConfig {
     ...
     */
    public WheelCalendar mCurrentCalendar = new WheelCalendar(PublicWay.currentNetTime==0?System.currentTimeMillis():PublicWay.currentNetTime);
