 ...
 * //已结束
 */
public class RepairsCompleteAdapter extends ModeListAdapter<ServiceMainExpandTo> {
    private Context  mContext;
    Compare compare=new Compare();

    public RepairsCompleteAdapter(Context context) {
        super(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        System.out.println(mode.getTypeName()+"mode");
        System.out.println(mode.getCreatedOn()+"create");
        //typeName   类型
        //time  天
        //date  年
...
//                    holder.getmEvalua().setBackgroundResource(R.drawable.warn);
       ...
       /// holder.getmServiceBooking().setText( mode.getServiceBookingTime());//预约时间
        ...
        System.out.println(createOnTime+"time+"+mode.getServiceBookingTime());
        ...
        if (mode.getServiceBookingTime()!=null && StringUtils.isNotEmpty(mode.getServiceBookingTime()))
        {
            ...
            //处理超时 超时大于24小时
            System.out.println(createOnTime+"createOnTime");
