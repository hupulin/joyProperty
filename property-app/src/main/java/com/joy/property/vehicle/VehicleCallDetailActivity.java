 ...
 */
public class VehicleCallDetailActivity extends BaseActivity
    ...
    private void findById() {
        ...
        getmServiceNumbr = (TextView) findViewById(R.id.tv_number);
    ...
    private void initDatas() {
        ...
        System.out.println(mServiceSid);
            ...
            public void success(MessageTo<ServiceMainExpandTo> msg, Response response) {
                ...
                if (msg.getSuccess() == 0) {
                    if (msg.getData() != null) {
                        ...
                        System.out.println(mainExpandTo.getTypeName()+"--------------"+mainExpandTo.getCarNo()+mainExpandTo.getIllegallyParkedNotion()+mainExpandTo.getIllegallyParkedPostion());
                        runOnUiThread(() -> {
                            init();
                        });
                    }
    ...
    private void init() {
        ...
        }else if ("2".equals(mainExpandTo.getServiceStatus())) {
    ...
    private void evaluationShow() {
        ...
        EvaluationSubmit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mParam.setEvaluationItem1((int) mRate01.getRating());
                mParam.setEvaluationItem2((int) mRate02.getRating());
                mParam.setEvaluationItem3((int) mRate03.getRating());
    ...
    protected Context getThisContext() {
        return VehicleCallDetailActivity.this;
    }
