...
public class MySubmissionAdapter extends ModeListAdapter<ServiceMainExpandTo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!TextUtils.isEmpty(mode.getServiceEmergenctStatus())) {
            holder.getmEmergency().setVisibility(View.VISIBLE);
        ...
        holder.getmEmergency().setVisibility(View.GONE);

        if (TextUtils.isEmpty(mode.getServiceCategory())) {
            //默认图片
        //    holder.getmImageView().setImageResource(R.drawable.category_02);
            Picasso.with(mContext).load(R.drawable.category_02).into(holder.getmImageView());
        } else {
            //投诉
            if ("7D2B996C-12EC-4CD4-8499-B453E96AF11F".equals(mode.getServiceCategory())) {
             //   holder.getmImageView().setImageResource(R.drawable.category_03);
                //报修
                Picasso.with(mContext).load(R.drawable.category_03).into(holder.getmImageView());
             ...
             //   holder.getmImageView().setImageResource(R.drawable.category_01);
                //服务
                Picasso.with(mContext).load(R.drawable.category_01).into(holder.getmImageView());
             ...
             //   holder.getmImageView().setImageResource(R.drawable.category_04);
                //巡检
                Picasso.with(mContext).load(R.drawable.category_04).into(holder.getmImageView());
           ...
           //     holder.getmImageView().setBackgroundResource(R.drawable.category_10);
                Picasso.with(mContext).load(R.drawable.category_10).into(holder.getmImageView());
            }
        }
