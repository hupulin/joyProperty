 ...
 **/
public class MyShoppingAllAdapter extends ModeListAdapter<MyOlderTo> {
    private Context mContext;
    private int type;
    private boolean isAll;
    private int androidVersion=android.os.Build.VERSION.SDK_INT;
    String imagePath = "";
    public MyShoppingAllAdapter(Context context, int type, boolean isAll) {
        super(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mode != null) {
         imagePath="";
            ...
            if("待付款".equals(mode.getOrderStatus())){
            ...
            }else if("待发货".equals(mode.getOrderStatus())){
                ...
                holder.getDeleteOlder().setText("取消订单");
                holder.getExpressLayout().setVisibility(View.GONE);
            }else  if("待收货".equals(mode.getOrderStatus())){
                ...
                holder.getExpressLayout().setVisibility(View.VISIBLE);
            ...
            else  if("待评价".equals(mode.getOrderStatus())){
                ...
                holder.getDeleteOlder().setText("取消订单");
                holder.getExpressLayout().setVisibility(View.GONE);
            } else  if("已经完成".equals(mode.getOrderStatus())){
            ...
            holder.getPayOlder().setOnClickListener(view -> {
                if (confirmListener!=null)
                    confirmListener.setConfirm(mode.getOrderId()+"",0,mode.getOrderStatus());
            });
    ...
    public interface ConfirmListener {
        void setConfirm(String olderId, int type, String olderStatue);
