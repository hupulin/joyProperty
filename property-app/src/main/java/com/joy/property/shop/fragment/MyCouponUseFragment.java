...
public class MyCouponUseFragment extends BaseFragment {
    private View self;
    ...
    public MyCouponUseFragment(){

    }
    public MyCouponUseFragment(int type){
        this.type=type;
    }
    @Override
...
//        });
    ...
    private void initView() {
        ...
        mAdapter = new MyCouponAdapter(getThisContext(),1);
    ...
    public void getCouponUnUseList(int index) {
        ...
        api.getCouponUse(param, new HttpCallback<MessageToBulk<List<CouponTo>>>(getThisContext()) {
            @Override
            public void success(MessageToBulk<List<CouponTo>> msg, Response response) {
                ...
                if (msg.getCode() == 0) {
                    ...
                    if (msg.getMyUsedCouponList() != null) {
                        couponList.addAll(msg.getMyUsedCouponList());
