...
public class FinishFragment extends BaseFragment {
    ...
    private void setData(int index) {
        ...
        api.getFinishOlder(param, new HttpCallback<MessageToBulk<List<MyOlderTo>>>(getThisContext()) {
            @Override
            public void success(MessageToBulk<List<MyOlderTo>> msg, Response response) {
                ...
                if (msg.getCode() == 0) {
                    ...
                    if (msg.getMyFinishOrderList() != null)
                        shoppingList.addAll(msg.getMyFinishOrderList());
